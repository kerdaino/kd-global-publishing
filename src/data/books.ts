...
export const books: Book[] = [
  ...
  },
  {
    ...
    sampleFileUrl: "",
    shortDescription:
      "A coming soon series shaped from sermon messages into clear, readable Christian teaching resources.",
    description:
      "Sermon Book Series is a placeholder for future titles developed from sermons, ministry teachings, and message archives. Each book will be arranged to help readers study, reflect, and apply the message beyond the original service.",
    whatReadersWillLearn: [
  ...
  },
  {
    ...
    description:
      "Devotional Teaching Series is a coming soon collection designed for readers who want concise, faith-building lessons. The final content will be developed into devotional entries with scripture focus, reflection, and practical application.",
    whatReadersWillLearn: [
